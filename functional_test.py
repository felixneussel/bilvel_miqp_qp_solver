...
if __name__ == '__main__':
    ...
    max_u = np.power(sigma_u,1/3)
    max_l = np.power(sigma_l,1/3)
    ...
    solution,obj,runtime,times_in_sub,num_of_subs, status,gap = solve(problem_data,1e-5,infty,10,'remark_2','ST-K-C-S',1e6)
