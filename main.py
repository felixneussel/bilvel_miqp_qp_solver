...
if __name__ == "__main__":
    ...
    #Solve the problem
    solution,obj,runtime,times_in_sub,num_of_subs, status,gap = solve(input_data,tolerance-5,infty,infty,subproblem_mode,algorithm,big_m,optimized_binary_expansion)
